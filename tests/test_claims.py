...
def test_ui_readmes_and_metadata_do_not_make_unqualified_solver_claims():
    ...
    # docs/equilibrium-plan.md records what has and has not been done. A scoped
    # sentence was licensed on 2026-09-24 and withdrawn the same day (step 3i):
    # the empirical game let declared seats leave tsumogiri.
