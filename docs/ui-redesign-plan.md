...
3. A compact “more metrics” disclosure in each card: `存活P(胡)`, `P(流局)`, `E[胡牌值]`, and `E[放槍]`, with the same decimal formatting as today.
